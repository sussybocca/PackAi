...
// Fully functional, tested on iPhone, with robust error handling
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (!messagesDiv || !userInput || !sendButton) {
            console.error('Required DOM elements missing. Check your HTML.');
            return;
        }
        ...
        async function getAIResponse(userMessage) {
            if (!knowledgeBase.length) {
                console.warn('Knowledge base empty');
                return "I have no knowledge loaded. Check console.";
            }
        ...
        async function handleUserMessage(message) {
            ...
            console.log('User message:', trimmed); // Debug
        ...
        async function init() {
            ...
            if (combinedText) {
                ...
                console.log(`Loaded ${baseKnowledge.length} base pairs`);
            } else {
                console.warn('No knowledge from API key.');
            }

            const learned = await loadLearnedPairs();
            console.log(`Loaded ${learned.length} learned pairs`);
            ...
            // Also handle touch events for iPhone
            ...
            if (knowledgeBase.length === 0) {
                addMessage('⚠️ No knowledge files loaded. Check console.', 'ai');
            } else {
